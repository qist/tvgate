...
export const [getLastChannelId, saveLastChannelId] = createStore<string | null>(
  "tvgate-player-last-channel-id",
  null,
);
export const [getSidebarVisible, saveSidebarVisible] = createStore("tvgate-player-sidebar-visible", true);
export const [getSeamlessSwitch, saveSeamlessSwitch] = createStore("tvgate-player-seamless-switch", () =>
  isDesktopDevice(),
);
export const [getAutoDeinterlace, saveAutoDeinterlace] = createStore("tvgate-player-auto-deinterlace", () =>
  isDesktopDevice(),
);
export const [getPictureEnhancement, savePictureEnhancement] = createStore("tvgate-player-picture-enhancement", () =>
  isDesktopDevice(),
);
...
const [getSourceIndexMap, saveSourceIndexMap] = createStore<Record<string, number>>(
  "tvgate-player-last-source-index",
  {},
);
