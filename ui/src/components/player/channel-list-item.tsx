  ...
  ({ channel, isCurrentChannel, handleChannelClick, locale, currentProgram }, ref) => {
    ...
    return (
      ...
      >
        ...
        {/* Right: Logo */}
        {channel.logo && (
          <div className="player-performance-logo-background relative z-10 flex h-8 w-14 shrink-0 items-center justify-center overflow-hidden rounded-xl border border-violet-900/8 bg-[linear-gradient(145deg,rgba(15,42,72,0.88),rgba(49,46,129,0.76))] px-1.5 py-0.5 shadow-[inset_0_1px_0_rgba(255,255,255,0.12)] dark:border-violet-100/10 md:h-10 md:w-20 md:px-2 md:py-1">
            <img
              src={channel.logo}
              alt={channel.name}
